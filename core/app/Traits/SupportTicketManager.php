...
trait SupportTicketManager
{
    ...
    public function supportTicket()
    {
        ...
        $view = ($this->userType == 'agent') ? 'agent.support.index' : "Template::$this->userType" . '.support.index';
        return view($view, compact('supports', 'pageTitle'));
    }
    ...
    public function openSupportTicket()
    {
        ...
        $view = ($this->userType == 'agent') ? 'agent.support.create' : "Template::$this->userType" . '.support.create';
        return view($view, compact('pageTitle', 'user'));
    }
    ...
    public function viewTicket($ticket)
    {
        ...
        $view = ($this->userType == 'agent') ? 'agent.support.view' : "Template::$this->userType" . '.support.view';
